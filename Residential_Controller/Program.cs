...
namespace Residential_Controller
{
    ...
    public class ElevatorController
    {
        ...
        public void requestElevator(int floorNumber, string direction)
        {
            ...
            Console.WriteLine("Request at floor " + floorNumber + " to go " + direction);
            Console.WriteLine("Elevator choose to respond to the request:");
            Console.WriteLine(Elevator.elevatorNumber);
        ...
        */
        ...
        public void bubbleSort(List<int> floorList, string direction)
        {
            ...
            Console.Write("Sorted floorList : ");
            floorList.ForEach(Console.WriteLine);
        }
        public void operateElevator(Elevator Elevator, string direction)
        {
            ...
            while (Elevator.floorList.Count > 0)
            {
                ...
                if (Elevator.floorList[0] == Elevator.currentFloor)
                {
                    ...
                    if(Elevator.floorList.Count > 0){
                        Console.Write("new list : ");
                        Elevator.floorList.ForEach(Console.WriteLine);
            ...
            if (Elevator.floorList.Count < 1)
            {
                ...
                Console.WriteLine("Elevator number " + Elevator.elevatorNumber + " status' is " + Elevator.status);
            }
        }
        public void moveUp(Elevator Elevator)
        {
            if (Elevator.status == "IDLE" || Elevator.status == "STOPPED")
            {
                ...
                Console.WriteLine("Elevator is " + Elevator.status + " " + Elevator.direction);
            }
            this.timer(2000);
        ...
        public void RequestFloor(int Elevator, int RequestedFloor)
        {
            ...
            Console.WriteLine("User is in elevator number " + Elevator + " and going to floor " + RequestedFloor);
            this.bubbleSort(elevator.floorList, elevator.direction);
